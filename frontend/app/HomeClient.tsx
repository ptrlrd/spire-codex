    ...
    <>
      ...
      <section className="hsec">
        <div className="s-head">
          <h2>{t("Characters")}</h2>
          <Link prefetch={false} className="viewmore" href="/characters">
            {t("All characters")} {ARROW}
          </Link>
        </div>
