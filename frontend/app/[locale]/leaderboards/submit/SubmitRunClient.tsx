      ...
      {insight && (
        ...
        >
          <div className="flex items-center gap-2 mb-3">
            ...
            >
              {insight.win ? t("Victory") : t("Defeat")}
            </span>
          ...
          {insight.archetype && (
            <div className="mb-3">
              ...
              <p className="text-sm text-[var(--text-secondary)]">
                {insight.archetype.win_rate}% {t("community win rate")} ·{" "}
                {insight.archetype.share}% {t("of runs")}
              </p>
            </div>
          )}
        ...
        <section>
          ...
          {runsLoading ? (
            ...
            <p className="text-sm text-[var(--text-secondary)] py-4">
              {t("No runs yet. Upload .run files above to get started.")}
            </p>
          ) : (
