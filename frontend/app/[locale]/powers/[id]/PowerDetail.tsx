...
export default function PowerDetail({ initialPower }: { initialPower?: Power | null } = {}) {
  ...
  const typeLabel = power.type === "None" ? t("Neutral") : power.type;
        ...
        <main className="main">
          ...
          {relatedCards.length > 0 && (
            <section id="relations">
              <h2>{t("Relations")}</h2>
              <p className="h-note">{t("Cards that apply this power.")}</p>
              <div className="rel">
            ...
            <div className="facts">
              ...
              <dl>
                ...
                {power.allow_negative != null && (
                  <div className="frow">
                    <dt>{t("Negative allowed")}</dt>
                    <dd>{power.allow_negative ? t("Yes") : t("No")}</dd>
                  </div>
                )}
                {relatedCards.length > 0 && (
                  <div className="frow">
