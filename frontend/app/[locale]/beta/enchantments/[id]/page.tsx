...
import EnchantmentDetail from "@/app/[locale]/enchantments/[id]/EnchantmentDetail";
...
export default async function Page({ params }: Props) {
  ...
  try {
    ...
    // EnchantmentDetail refetches client-side (with channel=beta via the /beta
    // path) and renders its own not-found state.
  }
  return <EnchantmentDetail initialEnchantment={item} />;
}
