...
export async function TierListBody({ lang }: { lang: Locale }) {
  ...
  const jsonLd = [
    buildBreadcrumbJsonLd([
      ...
      { name: t("Tier List"), href: localePath(lang, "/tier-list") },
    ]),
