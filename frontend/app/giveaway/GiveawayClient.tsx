  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <p className="text-[var(--text-secondary)] text-lg leading-relaxed mb-5">
        ...
        . {t("Enter free in three steps. The contest runs", lang)}{" "}
        {WINDOW_LABEL}.
      </p>
      ...
      >
        ...
        <div className="mt-1 text-sm text-[var(--text-secondary)]">
          ...
          {t("View the prize on", lang)} artovision3d.com.
        </div>
      </a>
      ...
      >
        {loading ? (
          <p className="text-sm text-[var(--text-secondary)]">
            {t("Checking your entry status...", lang)}
          </p>
        ) : entered ? (
          <p className="text-sm">
            <span className="font-semibold text-emerald-300">
              {t("You are entered.", lang)}
            </span>{" "}
      ...
      <div className="space-y-4 mb-10">
        <StepCard n={1} done={hasSteam} title={t("Sign in with Steam", lang)}>
          ...
          {hasSteam ? (
            <p className="text-emerald-300">
              {t("Signed in as", lang)}{" "}
              {user?.username ?? t("your account", lang)}.
            </p>
          ) : (
        ...
        <StepCard
          ...
          title={t("Upload at least one run", lang)}
        >
          <p>
            {t(
          ...
          {hasRun ? (
            <p className="text-emerald-300">
              ...
              {t("on your account. You are good.", lang)}
            </p>
          ) : (
...
Santa Rosa, CA 95406`}
      ...
      <div className="rounded-xl border border-[var(--border-subtle)] bg-[var(--bg-card)] p-5 text-sm text-[var(--text-secondary)] space-y-2">
        ...
        <p>
          <b className="text-[var(--text-primary)]">{t("Dates:", lang)}</b>{" "}
          {WINDOW_LABEL}.{" "}
