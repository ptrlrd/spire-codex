...
import { X7 } from "@/lib/i18n-x7";
import { X8A } from "@/lib/i18n-x8a";
import { X8B } from "@/lib/i18n-x8b";
import { X8C } from "@/lib/i18n-x8c";
import { X8D } from "@/lib/i18n-x8d";
import { X8E } from "@/lib/i18n-x8e";
import { X9A } from "@/lib/i18n-x9a";
...
const TABLES = [UI_TRANSLATIONS, X1, X2, X3, X4, X5, X6A, X6B, X6C, X6D, X6E, X6G, X7, X8A, X8B, X8C, X8D, X8E, X9A, X9B, X9C, X9D, X9E];
